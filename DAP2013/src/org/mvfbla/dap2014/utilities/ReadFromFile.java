...
public class ReadFromFile {
	...
	public static void selectReader(String s){
		...
		if(s.equals("WORKSHOPS")){
			input = OpenFile.open("Files\\WORKSHOPS.txt"); //desktop
		}
		if(s.equals("PARTICIPANTS")){ //participants
			input = OpenFile.open("Files\\PARTICIPANTS.txt"); //desktop
		}
		if(s.equals("WKSHP_REGISTRATIONS")){
			input = OpenFile.open("Files\\WKSHP_REGISTRATIONS.txt"); //desktop
		}
		if(s.equals("CONFERENCES")){
			input = OpenFile.open("Files\\CONFERENCES.txt"); //desktop
		}
	}
	/**
	 * @param s
